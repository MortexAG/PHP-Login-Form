...
if (empty($uname) && empty($pass) && empty($niname)){
  $both_empty = "<center><h1 style='color:red;'>Username And Password Can't Be Empty</h1></center> <meta http-equiv='refresh' content='3; URL=/register.php' />";
	    echo $both_empty;
}
else if (empty($uname)) {
...
$sql = "INSERT INTO `$users_table` (id, username, password, nickname) VALUES (0, '$username', '$password', '$nickname')";
